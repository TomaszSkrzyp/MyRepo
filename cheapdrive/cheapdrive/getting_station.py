from globals_and_inputs import avg, get_distance,go_and_get_distance, get_link, geopy, coord_finder, cur_fuel,WebDriverWait,By,INFINITY,EC,wait_for_word
import requests
import time
...
def best_station_available(driver,start, finish, avg):
    ...
    for i in range(1, 5):  # Attempt to find a station across four search zones
        ...
        for k in range(3):  # Check three stations per zone
            ...
            print(s_g_distance * avg ,cur_fuel)
